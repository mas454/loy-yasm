...
class RubyVM
  class Assembler
    def self.simpledata_to_iseq s
      RubyVM::InstructionSequence.load(s)
    end
    ...
    class SimpleDataBuilder
      ...
      RubyVM::InstructionSequence::Instruction::InsnID2NO.each_key{|insn|
      ...
      def sym2lidx sym
        ...
        #@local_sdb.locals.size - @local_sdb.locals.index(sym) + 1
